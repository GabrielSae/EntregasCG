...
public:
	...
	static const int WIDTH = 1023;
	static const int HEIGHT = 1023;
	...
	void putPixel_O(const int& x, const int& y, const char& R, const char& G, const char& B, const char& A);
	void putPixel1(const int& x, const int& y, Color c);
