...
{
	Mat4 result;
	result.m[0][0] = (m[0][0] * rh.m[0][0]) + (m[0][1] * rh.m[1][0]) + (m[0][2] * rh.m[2][0]) + (m[0][3] * rh.m[2][0]);
	result.m[0][1] = (m[0][0] * rh.m[0][1]) + (m[0][1] * rh.m[1][1]) + (m[0][2] * rh.m[2][1]) + (m[0][3] * rh.m[2][1]);
	result.m[0][2] = (m[0][0] * rh.m[0][2]) + (m[0][1] * rh.m[1][2]) + (m[0][2] * rh.m[2][2]) + (m[0][3] * rh.m[2][2]);
	result.m[0][3] = (m[0][0] * rh.m[0][3]) + (m[0][1] * rh.m[1][3]) + (m[0][2] * rh.m[2][3]) + (m[0][3] * rh.m[2][3]);
	result.m[1][0] = (m[1][0] * rh.m[0][0]) + (m[1][1] * rh.m[1][0]) + (m[1][2] * rh.m[2][0]) + (m[1][3] * rh.m[2][0]);
	result.m[1][1] = (m[1][0] * rh.m[0][1]) + (m[1][1] * rh.m[1][1]) + (m[1][2] * rh.m[2][1]) + (m[1][3] * rh.m[2][1]);
	result.m[1][2] = (m[1][0] * rh.m[0][2]) + (m[1][1] * rh.m[1][2]) + (m[1][2] * rh.m[2][2]) + (m[1][3] * rh.m[2][2]);
	result.m[1][3] = (m[1][0] * rh.m[0][3]) + (m[1][1] * rh.m[1][3]) + (m[1][2] * rh.m[2][3]) + (m[1][3] * rh.m[2][3]);
	result.m[2][0] = (m[2][0] * rh.m[0][0]) + (m[2][1] * rh.m[1][0]) + (m[2][2] * rh.m[2][0]) + (m[2][3] * rh.m[2][0]);
	result.m[2][1] = (m[2][0] * rh.m[0][1]) + (m[2][1] * rh.m[1][1]) + (m[2][2] * rh.m[2][1]) + (m[2][3] * rh.m[2][1]);
	result.m[2][2] = (m[2][0] * rh.m[0][2]) + (m[2][1] * rh.m[1][2]) + (m[2][2] * rh.m[2][2]) + (m[2][3] * rh.m[2][2]);
	result.m[2][3] = (m[2][0] * rh.m[0][3]) + (m[2][1] * rh.m[1][3]) + (m[2][2] * rh.m[2][3]) + (m[2][3] * rh.m[2][3]);
	result.m[3][0] = (m[3][0] * rh.m[0][0]) + (m[3][1] * rh.m[1][0]) + (m[3][2] * rh.m[2][0]) + (m[3][3] * rh.m[2][0]);
	result.m[3][1] = (m[3][0] * rh.m[0][1]) + (m[3][1] * rh.m[1][1]) + (m[3][2] * rh.m[2][1]) + (m[3][3] * rh.m[2][1]);
	result.m[3][2] = (m[3][0] * rh.m[0][2]) + (m[3][1] * rh.m[1][2]) + (m[3][2] * rh.m[2][2]) + (m[3][3] * rh.m[2][2]);
	result.m[3][3] = (m[3][0] * rh.m[0][3]) + (m[3][1] * rh.m[1][3]) + (m[3][2] * rh.m[2][3]) + (m[3][3] * rh.m[2][3]);
	return result;
}
...
Mat4& Mat4::LookAt(const Vec4& eye, const Vec4& target, const Vec4& up) {
	Vec4 tarmenoseye;
	for (int i = 0; i < 3; ++i) {
		tarmenoseye.m[i] = target.m[i] - eye.m[i];
	}
	tarmenoseye.m[3] = 1;
